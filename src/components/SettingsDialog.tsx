...
const SettingsDialog = ({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DrawerHeader>
          <DrawerTitle style={{ color: glowColor }}>Settings</DrawerTitle>
          <DrawerClose className="absolute right-4 top-4 text-white hover:text-red-500 text-2xl">
            ✕
          </DrawerClose>
        </DrawerHeader>

        <div className="p-4 overflow-y-auto max-h-[calc(100vh-100px)] scrollbar-thin space-y-6">
          {/* Theme Picker */}
